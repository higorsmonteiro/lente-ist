...
class SinanAidsAdultoInfo:
    def __init__(self, metadata):
        ...
        self._dummy_ = ['ID', 'NU_NOTIFIC', 'TP_NOT', 'ID_AGRAVO', 'CS_SUSPEIT',
                        'SEM_NOT', 'NU_ANO', 'SG_UF_NOT', 'ID_MUNICIP', 'ID_REGIONA',
                        'ID_UNIDADE', 'NU_IDADE_N', 'CS_GESTANT',
                        'CS_RACA', 'CS_ESCOL_N', 'SG_UF', 'ID_MN_RESI', 'ID_RG_RESI', 
                        'ID_DISTRIT', 'ID_BAIRRO', 'NM_BAIRRO', 'ID_LOGRADO', 'NM_COMPLEM', 
                        'NM_REFEREN', 'NU_CEP', 'NU_DDD_TEL', 'NU_TELEFON',
                        'CS_ZONA', 'ID_PAIS',
                        'ID_OCUPA_N', 'ANT_TRASMI', 'ANTRELSE_N', 'ANT_DROGA',
        ...
        self.model = Table(
            ...
            Column('NU_NOTIFIC', String, nullable=True), 
            Column('TP_NOT', String, nullable=True), 
            Column('ID_AGRAVO', String, nullable=True), 
            Column('CS_SUSPEIT', String, nullable=True),
            Column('SEM_NOT', String, nullable=True), 
            Column('NU_ANO', String, nullable=True), 
            Column('SG_UF_NOT', String, nullable=True), 
            Column('ID_MUNICIP', String, nullable=True), 
            Column('ID_REGIONA', String, nullable=True),
            Column('ID_UNIDADE', String, nullable=True), 
            Column('NU_IDADE_N', String, nullable=True), 
            Column('CS_GESTANT', String, nullable=True),
            Column('CS_RACA', String, nullable=True), 
            Column('CS_ESCOL_N', String, nullable=True), 
            Column('SG_UF', String, nullable=True), 
            Column('ID_MN_RESI', String, nullable=True), 
            Column('ID_RG_RESI', String, nullable=True), 
            Column('ID_DISTRIT', String, nullable=True), 
            Column('ID_BAIRRO', String, nullable=True), 
            Column('NM_BAIRRO', String, nullable=True), 
            Column('ID_LOGRADO', String, nullable=True), 
            Column('NM_COMPLEM', String, nullable=True), 
            Column('NM_REFEREN', String, nullable=True), 
            Column('NU_CEP', String, nullable=True), 
            Column('NU_DDD_TEL', String, nullable=True), 
            Column('NU_TELEFON', String, nullable=True),
            Column('CS_ZONA', String, nullable=True), 
            Column('ID_PAIS', String, nullable=True),
...
class SinanAidsCriancaInfo:
    def __init__(self, metadata):
        ...
        self._dummy_ = ['ID', 'NU_NOTIFIC', 'TP_NOT', 'ID_AGRAVO', 'CS_SUSPEIT',
                        ...
                        'NM_REFEREN', 'NU_CEP', 'NU_DDD_TEL', 'NU_TELEFON',
                        'CS_ZONA', 'ID_PAIS',
                        'IDADE_MAE', 'ESC_MAE', 'RACA_MAE', 'ID_OCUP_MA', 'TIPO_INVES',
